...
train_val, test_multimodal, train_val_labels, test_labels, train_val_numbers, test_split = train_test_split(
    normalized_multimodal,
    labels,
    numbers,
    test_size=0.15,
...
train_multimodal, val_multimodal, train_labels, val_labels, train_split, val_split = train_test_split(
    train_val,
    train_val_labels,
    train_val_numbers,
    test_size=0.1765,  # Approximately 15% of total data
    random_state=42,
